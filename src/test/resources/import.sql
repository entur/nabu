...
insert into chouette_info(id, prefix, data_space, organisation, cuser, regtopp_version, regtopp_coordinate_projection) values (1, 'flybussekspressen', 'flybussekspressen', 'Rutebanken', 'admin@rutebanken.org', 'R12', 'EPSG:32632');
insert into chouette_info(id, prefix, data_space, organisation, cuser, regtopp_version, regtopp_coordinate_projection) values (2, 'flybussekspressen2', 'flybussekspressen2', 'Rutebanken2', 'admin2@rutebanken.org', 'R12', 'EPSG:32632');
