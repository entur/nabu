...
insert into ENTITY_CLASSIFICATION_ASSIGNMENT (1,responsibility_role_assignment_pk, entity_classifications_pk, allowed) values (1,1,'t');
insert into ENTITY_CLASSIFICATION_ASSIGNMENT (2,responsibility_role_assignment_pk, entity_classifications_pk, allowed) values (1,3,'t');
