...
insert into chouette_info(prefix, data_space, organisation, cuser) values ('flybussekspressen', 'flybussekspressen', 'Rutebanken', 'admin@rutebanken.org');
insert into chouette_info(prefix, data_space, organisation, cuser) values ('flybussekspressen2', 'flybussekspressen2', 'Rutebanken2', 'admin2@rutebanken.org');
