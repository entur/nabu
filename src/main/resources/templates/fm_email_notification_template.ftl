...
<body>
<h3>${message("notification.email.header")}</h3>
...
<#list jobEvents as jobDomain,jobEventsForDomain>
    <h4>${message("notification.email.jobevent.domain.${jobDomain}")}</h4>
    <table>
        <tr>
...
<#list crudEvents as entityType,crudEventsForType>
    <h4>${message("notification.email.crudevent.entitytype.${entityType}")}</h4>
    <table>
        <tr>
