...
insert into public.chouette_info(id, prefix, referential, organisation, cuser, regtopp_version, regtopp_coordinate_projection, data_format) values (19, 'NRI', 'nri', 'Rutebanken', 'admin@rutebanken.org', null, null,'gtfs');
