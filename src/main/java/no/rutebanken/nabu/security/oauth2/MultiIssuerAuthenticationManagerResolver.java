...
public class MultiIssuerAuthenticationManagerResolver
    ...
    @Value("${nabu.oauth2.resourceserver.keycloak.jwt.audience}")
    private String keycloakAudience;

    @Value("${nabu.oauth2.resourceserver.keycloak.jwt.issuer-uri}")
    private String keycloakIssuer;

    @Value("${nabu.oauth2.resourceserver.keycloak.jwt.jwkset-uri}")
